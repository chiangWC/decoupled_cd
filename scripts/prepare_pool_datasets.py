...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare reproducible Junyi and EdNet pool protocols.")
...
def main() -> None:
    ...
    if args.split_seed != 2024:
        raise ValueError("Dataset pool protocols are fixed to split_seed=2024.")
