...
- 实验 102 表明 experiment 95 与 experiment 100 checkpoint 的排序误差有互补性；如果继续 pure-CDM default promotion，优先围绕固定 prediction average / checkpoint-average evaluator 语义推进，不要回到 dim80 单模型局部扫参。
- CF residual 支线暂停:
