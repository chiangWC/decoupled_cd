...
- 当前正向支线候选:
  - 实验 37
    ...
    - 详细指标见 [037_recompute_minibatch_training.md](./experiments/037_recompute_minibatch_training.md)
  - 实验 61
    ...
    - 详细指标见 [061_full_target_excluded_training_audit.md](./experiments/061_full_target_excluded_training_audit.md)
...
- 暂停中的 CF 支线:
  ...
  - 详情: [038_040_cf_residual_family.md](./experiments/038_040_cf_residual_family.md)；结构化状态见 [experiment_index.jsonl](./experiment_index.jsonl)
...
- 实验 8: 长训
  ...
  - 判断: 正式结构比较默认采用长训协议
- 实验 9: 多 seed
  - 详情: [009_multiseed_protocol.md](./experiments/009_multiseed_protocol.md)
  - 判断: 多 seed 稳定性成为正式比较要求
- 实验 11: `TKC/UKC` 结构传播参数解耦
  - 详情: [011_tkc_ukc_decoupled_propagation.md](./experiments/011_tkc_ukc_decoupled_propagation.md)
  - 判断: TKC/UKC 传播参数解耦是可靠正向结构改动
- 实验 12: `TKC` 正误双通道行为消息
  - 详情: [012_tkc_correct_incorrect_messages.md](./experiments/012_tkc_correct_incorrect_messages.md)
  - 判断: 错题证据必须保留为 TKC 行为消息
- 实验 21: `TKC/UKC` 学生自适应融合 gate
  - 详情: [021_student_adaptive_fusion_gate.md](./experiments/021_student_adaptive_fusion_gate.md)
  - 判断: 学生级 TKC/UKC 自适应融合 gate 成为默认配置
- 实验 23: 修正 `TKC` 行为项全局二次缩小
  - 详情: [023_tkc_behavior_scaling_fix.md](./experiments/023_tkc_behavior_scaling_fix.md)
  - 判断: 修正行为项全局二次缩小后形成稳定基座
- 实验 33: `cognitive_match` zero-init difficulty adapter
  - 详情: [033_cognitive_difficulty_adapter.md](./experiments/033_cognitive_difficulty_adapter.md)
  - 判断: zero-init difficulty adapter 解决实验 29 崩盘并改善五指标
- 实验 34: high-concept logit adapter + `guess/slip` difficulty adapter
  - 详情: [034_high_concept_gs_difficulty_adapters.md](./experiments/034_high_concept_gs_difficulty_adapters.md)
  - 判断: 实验 49/51/70 前的正式主线底座
- 实验 49: history-carrier pairwise interaction residual
  - 详情: [049_history_carrier_pairwise_interaction.md](./experiments/049_history_carrier_pairwise_interaction.md)
  - 判断: history-carrier pairwise interaction residual 已吸收到主线
- 实验 37: true mini-batch recompute training
  - 详情: [037_recompute_minibatch_training.md](./experiments/037_recompute_minibatch_training.md)
